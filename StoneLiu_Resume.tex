...
\resumeItem { Created reusuable dashboard components written with \textbf{Vue.js}, enabling over \textbf{3000+} contractors to access detailed incident reports on spills.   }
