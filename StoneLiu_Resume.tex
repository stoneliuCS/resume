...
\begin{center}
	...
	\small 617-792-6757 $|$ \href{mailto:liu.sto@northeastern.edu}{liu.sto@northeastern.edu} $|$
	\href{https://linkedin.com/in/stone-liu}{linkedin/stone-liu} $|$
	\href{https://stoneliucs.github.io}{stoneliucs.github.io} $|$
	\href{https://github.com/stoneliuCS}{github.com/stoneliuCS}
\end{center}
...
\resumeItemListStart
\resumeItem{\textbf{GPA:} 3.80 / 4.00 }
\resumeItemListEnd
...
\begin{itemize}[leftmargin=0.15in, label={}]
	\small{\item{
	      ...
	      \textbf{Technologies/Frameworks}{: Vim, Docker, Git, React.js, AWS (S3, Lambda, EC2, IAM), Apache (Spark, Maven) }
	      }}
\end{itemize}
...
\resumeSubheading
{Member of Technical Staff}{January 2026 -- Present}
{Agency - Sequoia Capital, Databricks Ventures }{New York City, NY}
...
\resumeItemListStart
\resumeItem { Designed a containerized challenge server in \textbf{Go} with \textbf{PostgreSQL} to auto‑grade technical challenges for \textbf{200+} prospective engineers. }
...
\resumeItem { Led infrastructure integrations with \textbf{AWS S3 \& Lambda} using \textbf{Boto3} enabling organization-wide
	access through least privilege \textbf{IAM} policies and roles. }
\resumeItemListEnd
...
\resumeItemListStart
\resumeItem { Implemented a F1-score based tracking metric for object detection models in \textbf{C++}, giving stakeholders faster insights into model performance. }
...
% {Generate Product Development Studio}{Boston, MA}
% \resumeItemListStart
% \resumeItem { Led an \textbf{agile} team of 7 software engineers, designing a containerized \textbf{RESTful} web backend and \textbf{iOS} mobile application using \textbf{React-Native}.}
% \resumeItem{
% 	Implemented server-side features that supported media compression and serving through \textbf{AWS S3} and increased app engagement with
% 	scheduled nudges using \textbf{AWS Lambda}.
% }
...
\resumeItemListStart
\resumeItem { Created a distributed trading card game using \textbf{Apache Maven}, where player mechanisms connect over \textbf{TCP/IP} sockets.}
\resumeItem { Developed a backtracking algorithm that efficiently searched through millions of candidates using DFS and data accumulators.}
\resumeItemListEnd
% \resumeProjectHeading
