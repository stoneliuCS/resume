...
\resumeItem { Designed a scalable test harness using \textbf{Apache Spark}, supporting parallel data processing on \textbf{100 million+ metrics} giving team members insights into model performance.}
...
\resumeItem{Deployed CI/CD pipelines using \textbf{Github Actions}, automating over \textbf{500+} integration tests written using \textbf{Jest} and containerized deployments through \textbf{Docker}. }
...
\resumeItem { Created a fluent, object-oriented interface allowing developers to repeatedly chain together methods, enabling for more maintainable API specifications. }
\resumeItem { Maintained backwards compatibility between all OpenAPIv3 specifications through interface segregation, providing support for more than \textbf{1800} developers on npm. }
