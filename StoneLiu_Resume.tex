...
\begin{center}
	...
	\small 617-792-6757 $|$ \href{mailto:liu.sto@northeastern.edu}{liu.sto\{at\}northeastern\{dot\}edu} $|$
...
\resumeItem { Led infrastructure integrations with \textbf{AWS S3 \& Lambda} using \textbf{Boto3} enabling organization
	wide access through least privilege \textbf{IAM} policies and roles. }
\resumeItemListEnd
