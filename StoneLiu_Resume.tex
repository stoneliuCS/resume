...
\resumeItemListStart
\resumeItem { \href{https://github.com/stoneliuCS/fluid-oas}{\emph{Fluid-OAS}} is a declarative \emph{domain specific language} expressing type-safe HTTP APIs using the OpenAPI specification.  }
...
\resumeItem { Maintained backwards compatability among all OpenAPIv3 specifications through interface segregation, supporting \textbf{1500+} developers. }
