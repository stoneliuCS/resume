...
\begin{itemize}[leftmargin=0.15in, label={}]
	\small{\item{
	      ...
	      \textbf{Technologies/Frameworks}{: Vim, Docker, Git, React.js, Vue.js Apache Spark \& Maven, AWS S3 \& Lambda }
	      }
	      }
\end{itemize}
...
\resumeItemListStart
\resumeItem { Designed a distributed, containerized challenge server using \textbf{Go} and \textbf{PostgreSQL}, facilitating the autograding of technical challenges for over \textbf{100+} prospective software engineers. }
...
\resumeItem { Interfaced with \textbf{AWS} infrastructure using \textbf{Boto3} enabling \textbf{4} teams access to
	\textbf{S3 and Lambda} through least privilege IAM policies. }
\resumeItemListEnd
...
{Generate Product Development Studio}{Boston, MA}
\resumeItemListStart
\resumeItem { Led an \textbf{agile} team of 7 software engineers, designing a containerized \textbf{RESTful} web server application through the \textbf{OpenAPI} specification.}
\resumeItem{
