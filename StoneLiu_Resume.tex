...
\resumeItem{Designed \textbf{PostgreSQL} database schema to model one to many, many to one, and many to many business entities for users, groups, posts, and notifications.}
\resumeItemListEnd
% \resumeProjectHeading
