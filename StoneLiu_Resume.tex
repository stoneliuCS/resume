...
\begin{center}
	...
	\textbf{Availability: May 2026 - September 2026} \\
...
\begin{itemize}[leftmargin=0.15in, label={}]
	\small{\item{
	      ...
	      \textbf{Technologies/Frameworks}{: Vim, Docker, Git, React.js, AWS S3 \& Lambda, Apache Spark \& Maven }
	      }}
\end{itemize}
...
\resumeItemListStart
\resumeItem { Designed a containerized challenge server using \textbf{Go} and \textbf{PostgreSQL}, efficiently autograding technical challenges for over \textbf{200} prospective software engineers. }
